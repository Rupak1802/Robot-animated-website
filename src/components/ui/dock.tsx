  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: `
        .dock-container .icon:hover + .icon {
        ...
        .dock-container .icon:hover + .icon + .icon {
        ...
        .dock-container .icon:has(+ .icon:hover) {
        ...
        .dock-container .icon:has(+ .icon + .icon:hover) {
...
export function Dock({
  ...
  return (
    <nav ref={dockRef} role="navigation" aria-label="Main Dock" className="dock-container flex justify-center">
      <ul
        className={cn(
          "flex items-center rounded-xl border border-gray-100 bg-gradient-to-t from-neutral-50 to-white p-1 dark:border-zinc-900 dark:from-zinc-950 dark:to-zinc-900 list-none",
          className
        )}
      >
